...
const Skills = () => {
  ...
  return (
    <section
      className="relative w-full min-h-screen max-w-6xl py-10 sm:py-14 md:py-16 mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-center overflow-hidden"
      id="skills"
