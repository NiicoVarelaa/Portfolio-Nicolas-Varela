...
const ProjectModal = ({ project, onClose }) => {
  ...
  }, [onClose, handlePrev, handleNext, previewOpen, closePreview, handlePrevPreview, handleNextPreview, videoOpen, closeVideo]);
          ...
          >
            ...
            >
              <div className="w-full bg-black rounded-xl overflow-hidden shadow-2xl">
                <iframe
                  src={`https://www.youtube.com/embed/${project.demoVideo}?autoplay=1&rel=0`}
